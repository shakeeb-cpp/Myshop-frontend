                            ...
                            <div className="lg:w-2/3 w-full mx-auto overflow-auto">
                                <table className="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        {cart.map((item) => {
                                            return <tr>
                                                <td className="flex py-6 "><img className='object-contain object-center h-16 w-16' src={`http://127.0.0.1:1337${item[2]}`} alt="" /><span className='my-auto ml-2 font-semibold'>{item[0]}</span></td>
